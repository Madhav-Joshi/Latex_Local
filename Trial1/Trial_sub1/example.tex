...
\section*{\color{blue}Awards and Achievements\xfilll[0pt]{0.5pt}}
	\vspace{-9pt}
    \begin{itemize}[itemsep = -1.5 mm, leftmargin=*]
    %\vspace{-17pt}
    
        \item Awarded \textbf{Institute Academic Award} for performing \(\mathbf{2^{nd}}\) best in the class for whole year \hfill{\sl\small (2022)}

        \item Among \textbf{Top 1.5\%} out of 200,000 students in JEE Advanced and received \textbf{99.54\%ile} in JEE Mains \hfill{\sl\small (2019)}

        \item \textbf{AIR} \boldmath{\(74\)} among 15K students in UCEED and ranked \boldmath{\(107^{th}\)} out of 390K examinees in MHT-CET \hfill{\sl\small (2019)}
    \end{itemize}
